...
<section class="text-center my-5 container" id="domain">
    ...
    <div class="row">
        <div class="col-12 col-lg-9">
            ...
            <h2 class="font-weight-bold my-5 text-center mb-5">{{setting('focus-introduction.outcome_title')}}</h2>
            @carouselresearch(['items'=>$domain->researches()->ordered()->get(), 'column_count'=>'2']) @endcarouselresearch
            <h2 class="font-weight-bold my-5 text-center mb-5">{{setting('focus-introduction.area_title')}}</h2>
            @carouselfigure(['items'=>$domain->peoples()->ordered()->get()]) @endcarouselfigure
        </div>
